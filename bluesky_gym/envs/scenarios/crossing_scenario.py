"""Crossing conflict scenario generator.

Intruders approach from the side with a ~90° track-angle difference,
representing a classic crossing conflict.
"""
...
class CrossingScenario:
    ...
    Args:
        ...
        dpsi_range: Conflict angle range [deg], default (60, 120) centred at 90°.
    ...
    def generate(self, target_acid: str = 'AC0', actype: str = 'A320'):
        """Generate crossing conflict intruders around *target_acid*.
    ...
    def get_description(self) -> str:
        ...
        return (
            ...
            f"  angle      : {self.dpsi_range[0]}\u2013{self.dpsi_range[1]} deg (centred 90\u00b0)\n"
